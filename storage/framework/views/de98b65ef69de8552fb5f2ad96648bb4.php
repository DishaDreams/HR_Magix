        ...
        <div class="custom-login-form">
            <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate="">
                ...
                <div class="form-group mb-3">
                    <label class="form-label"><?php echo e(__('Email')); ?> 345345345</label>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRMagix\hrmagix\app\resources\views/auth/login.blade.php ENDPATH**/ ?>